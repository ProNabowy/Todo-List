    ...
    const useActionBodyTemplate = (row) => {
        ...
        return (
            <div className="flex items-center gap-5">
                <img onClick={_ => setRow(row)} src="/images/pen.svg" className="w-[20px] cursor-pointer" alt="" />
                <img onClick={confirm} src="/images/trash.svg" className="w-[20px] cursor-pointer" alt="" />
            </div>
        )
    };
